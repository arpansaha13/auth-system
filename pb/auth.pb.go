...
type ValidateSessionResponse struct {
	...
	User          *UserData              `protobuf:"bytes,3,opt,name=user,proto3" json:"user,omitempty"`                    // User info when valid; unset when invalid
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidateSessionResponse) GetUser() *UserData {
	if x != nil {
		return x.User
	}
	return nil
...
const file_auth_proto_rawDesc = "" +
	...
	"\x16ValidateSessionRequest\"m\n" +
	"\x17ValidateSessionResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x14\n" +
	"\x05valid\x18\x02 \x01(\bR\x05valid\x12#\n" +
	"\x04user\x18\x03 \x01(\v2\x0f.proto.UserDataR\x04user\"\x17\n" +
	...
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtJ\x04\b\x04\x10\x05\"6\n" +
...
var file_auth_proto_depIdxs = []int32{
	...
	17, // 1: proto.ValidateSessionResponse.user:type_name -> proto.UserData
	25, // 2: proto.UserData.created_at:type_name -> google.protobuf.Timestamp
	17, // 3: proto.GetUserResponse.user:type_name -> proto.UserData
	17, // 4: proto.GetUserByEmailResponse.user:type_name -> proto.UserData
	6,  // 5: proto.AuthService.ValidateSession:input_type -> proto.ValidateSessionRequest
	8,  // 6: proto.AuthService.RefreshSession:input_type -> proto.RefreshSessionRequest
	12, // 7: proto.AuthService.ForgotPassword:input_type -> proto.ForgotPasswordRequest
	14, // 8: proto.AuthService.ResetPassword:input_type -> proto.ResetPasswordRequest
	16, // 9: proto.AuthService.GetUser:input_type -> proto.GetUserRequest
	19, // 10: proto.AuthService.GetUserByEmail:input_type -> proto.GetUserByEmailRequest
	21, // 11: proto.AuthService.DeleteUser:input_type -> proto.DeleteUserRequest
	23, // 12: proto.AuthService.LiveZ:input_type -> proto.LiveZRequest
	7,  // 13: proto.AuthService.ValidateSession:output_type -> proto.ValidateSessionResponse
	9,  // 14: proto.AuthService.RefreshSession:output_type -> proto.RefreshSessionResponse
	13, // 15: proto.AuthService.ForgotPassword:output_type -> proto.ForgotPasswordResponse
	15, // 16: proto.AuthService.ResetPassword:output_type -> proto.ResetPasswordResponse
	18, // 17: proto.AuthService.GetUser:output_type -> proto.GetUserResponse
	20, // 18: proto.AuthService.GetUserByEmail:output_type -> proto.GetUserByEmailResponse
	22, // 19: proto.AuthService.DeleteUser:output_type -> proto.DeleteUserResponse
	24, // 20: proto.AuthService.LiveZ:output_type -> proto.LiveZResponse
